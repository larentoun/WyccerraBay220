/proc/animated_teleportation(atom/movable/target, atom/anchor)
	...
	target.set_dir(2)
	target.forceMove(A)
	addtimer(CALLBACK(GLOBAL_PROC, GLOBAL_PROC_REF(animated_teleportation_ending), target, anchor), 23)
...
/proc/animated_teleportation_ending(atom/movable/target, atom/anchor)
	...
	addtimer(CALLBACK(GLOBAL_PROC, GLOBAL_PROC_REF(finalize_animated_teleportation), target, anchor), 24)
