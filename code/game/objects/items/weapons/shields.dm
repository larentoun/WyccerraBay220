...
/obj/item/shield/energy/proc/activate(mob/living/user)
	...
	update_icon()
	addtimer(CALLBACK(src, TYPE_PROC_REF(/obj/item/shield/energy, UpdateSoundLoop)), 0.25 SECONDS)
...
/obj/item/shield/energy/proc/deactivate(mob/living/user)
	...
	addtimer(CALLBACK(src, TYPE_PROC_REF(/obj/item/shield/energy, UpdateSoundLoop)), 0.1 SECONDS)
