...
/datum/category_item/player_setup_item/background/records/content(mob/user)
	...
	// var/list/branches = pref.for_each_selected_branch(CALLBACK(src, PROC_REF(allow_email_branch_check)) // SIERRA-EDIT - ORIGINAL
	...
	var/list/branches = pref.for_each_selected_branch(CALLBACK(src, PROC_REF(allow_email_branch_check)))
